...
export default function RadarPage() {
  ...
  async function runScan() {
    ...
    try {
      ...
      setFeedback(
        `Scan real concluido: ${data.summary.analyzed} analisados, ${data.summary.created} novos, ${data.summary.updated} atualizados e ${data.summary.alerted} alertas enviados.`
      )
    } catch (error) {
      console.error(error)
